...
{
    public abstract class final_project_newWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static final_project_newWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(final_project_newWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<final_project_newDbContext> action)
        {
            using (var context = IocManager.Resolve<final_project_newDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<final_project_newDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<final_project_newDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<final_project_newDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<final_project_newDbContext, Task<T>> func)
        {
            T result;
